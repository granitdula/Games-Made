...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.image = pygame.transform.scale(player_img, (50, 38)) #50, 38
...
power_sound = pygame.mixer.Sound(path.join(snd_dir, 'powerup_sound.wav'))
expl_sounds = []
...
while running:
    ...
    # When player dies and the explosion finished playing
